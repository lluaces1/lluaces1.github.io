...
Demonstrate commitment to our Lab Goals, which is to do research in areas that include a combination of: A) the classification of affective problems, B) treatment outcomes in affective disorders, C) processes and mechanisms of psychopathology in and out of treatment, or D) the study of individual differences in outcomes and processes relevant to affective disorders and related problems. The methods used will similarly vary but include: primary research consisting of treatment, experimental, and observational studies as well as secondary data analysis, mostly of randomized controlled trial (RCT) data, and meta-analytic reviews.  

Specifically, applicants with the following interests may be good fits to our lab:
...
As a mentor, I feel best-prepared to support students who are interested in careers that involve applied, clinical, and/or intervention research. This includes a wide variety of career paths, including academic faculty positions, e.g. in departments of psychology, education, social work, or public health; and combined clinical-research careers, e.g. in academic medical centers.
“Practice-based evidence” is core to our lab’s work and mission. However, I may not be the most effective mentor for applicants who are interested entirely in clinical practice careers.
