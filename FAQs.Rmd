...
The survey is [**here**](https://iu.co1.qualtrics.com/jfe/form/SV_9Z77lTMmbzRZN30) or paste https://iu.co1.qualtrics.com/jfe/form/SV_9Z77lTMmbzRZN30 on your browser.
...
As of `r Sys.Date()`, I am expecting to take graduate students for the next academic year. Below are some recommendations for when I am taking students:
...
- Lorenzo-Luaces, L., & Howard, J. (*in press*). Efficacy of a single session intervention for depression in online workers: A randomized controlled trial with transdiagnostic mental health outcomes. *Journal of Medical Internet Research.*
...
3. **Contributions to diverse ideas in our program/lab.** I care about the lack of diversity in academia, which is a major problem in many fields and leads to homogeneity in research topic. If a student would diversify the viewpoints represented in the lab or in our department, either by virtue of their lived experience or perspectives, I would consider that a major positive.
